...
export const experiencesData = [
  {
    ...
    points: [
      ...
      "Built Onehouse's notification platform end to end on a durable Kafka pipeline with at-least-once delivery, idempotency, and dead-lettering, replacing a fire-and-forget system that dropped failure alerts silently.",
      "Architected a new design system and shared component library, implemented Dark Theme platform-wide single-handedly, and created a Claude-based AI design workflow that lets engineers ship UI changes without design-team dependency.",
    ],
  ...
  },
  {
    ...
    location: "Bengaluru, Karnataka, India",
    points: [
      "Built shared CD capabilities including Git Experience for syncing pipelines with Git and Execution Strategy panels supporting rolling and blue-green deployments, using React, TypeScript, and Context API with coverage from Jest, React Testing Library, and Cypress.",
